...
class MailAgent {
    ...
    MailAgent(String mailServerAddress) {
        ...
        try {
            ...
            System.out.println("[mailClientService]-连接到" + mailServerAddress + "成功！");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    boolean sendMail(Map<String, String> params) {
        ...
        try {
            ...
            printWriter.flush();
            System.out.println(String.format("[mailClientService]-邮件发送成功！From:%s:To:%s!", username + "@" + this.postFix, params.get("tousername")));
        } catch (Exception e) {
            return false;
        }
        return true;
